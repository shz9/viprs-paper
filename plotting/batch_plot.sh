...
python plotting/plot_predictive_performance.py -m "SBayesR,VIPRSAlpha,VIPRSAlpha-GSvl_pe,VIPRSAlpha-GSv_p,VIPRSAlpha-GSvl_e,VIPRSAlpha-GSv_e" --prefix "viprsalpha_gs_v"
python plotting/plot_predictive_performance.py -m "SBayesR,VIPRSAlpha,VIPRSAlpha-GSl_pe,VIPRSAlpha-GS_p,VIPRSAlpha-GSl_e,VIPRSAlpha-GS_e" --prefix "viprsalpha_gs"
